...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.clawd/clawd_ex.json`
...
- The script prints a `MEDIA:` line for ClawdEx to auto-attach on supported chat providers.
