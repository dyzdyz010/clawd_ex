...
#
#     PHX_SERVER=true bin/clawd_ex start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
# Log directory (defaults to ~/.clawd/logs)
if log_dir = System.get_env("CLAWD_LOG_DIR") do
  config :clawd_ex, log_dir: log_dir
end
...
if config_env() == :prod do
  ...
  config :clawd_ex, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
